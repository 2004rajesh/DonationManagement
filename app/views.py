...
def delete_donations(request,pid):
    ...
    def post(self,request):
        ...
        try:
            if newpass == confirmpass:
                ...
                messages.warning(request,'Old Passsword and New Password are different')
        except:
...
class accepted_donationdetail(View):
    ...
    def post(self,request,pid):
        ...
        try:
            ...
            donation.save()
            messages.success(request,'Vounteer Allocated Successfully')
        except:
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.warning(request, f'Failed to save donation: {str(e)}')
        return render(request,'donate-now.html',locals())
...
class donationcollection_detail(View):
    ...
    def post(self,request,pid):
        ...
        try:
            ...
            donation.updationdate = date.today()
            donation.save()
            messages.success(request,'Volunteer Status & Remark updated Successfuilly')
        except:
...
class donationrec_detail(View):
    def get(self, request, pid):
        ...
        try:
            ...
            messages.warning(request, 'Donation does not exist.')
            return redirect('/index-admin')
    ...
    def post(self, request, pid):
        ...
        try:
            ...
            # Save delivery picture to the gallery
