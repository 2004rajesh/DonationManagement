...
class VolunteerSignupForm(forms.ModelForm):
    ...
    class Meta:
         ...
         widgets={
             ...
             'aboutme':forms.Textarea(attrs={'class':'form-control','rows':4,'placeholder':'Full Address'}),
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(label="Confirm Password",strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'confirm-password','class':'form-control','placeholder':'Confrim Password'}))
...
class DonationAreaForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            'areaname':forms.TextInput(attrs={'class':'form-control','placeholder':'Description Area'}),
